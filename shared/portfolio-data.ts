...
export const profileData = {
  ...
  experience: [
    ...
    {
      milestone: "Backend Engineering Layer",
      facility: "Ishtari Group",
      meta: "12/2025 – 01/2026",
      details:
        "Engineered scalable MVC backend components, managed relational schemas, and structured secure RESTful API systems.",
    },
    {
      milestone: "Quality Assurance Engine",
      facility: "Oigetit",
      meta: "05/2026 – Present",
      details:
        "Conducted continuous boundary testing, trace-level log debugging, and evaluated system flows to catch and fix core script anomalies.",
    },
    {
      milestone: "Web Development Trainer",
      facility: "KfW & EU Graduate Support Program · FALA Association",
      meta: "04/2025 – 06/2025",
      details:
